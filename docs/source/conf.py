...
# AEMET integration with Plone build configuration file
...
project = "AEMET integration with Plone"
...
html_theme_options = {
    ...
    "logo": {
        "text": "AEMET integration with Plone",
    },
...
html_use_opensearch = "https://collectivevoltoaemet.readthedocs.io"
...
htmlhelp_basename = "AEMET integration with PloneDocumentation"
...
latex_documents = [
    (
        "index",
        "AEMET integration with PloneDocumentation.tex",
        "AEMET integration with Plone Documentation",
